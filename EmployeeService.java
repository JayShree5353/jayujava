...
public class EmployeeService {
	...
	Employee emp2=new Employee(102,"Meena",26,"Tester","CS",57000);
	Employee emp3=new Employee(103,"Bob",20,"DevOps","Admin",5000);
	...
	public void addEmp() {
		...
		empset.add(emp);
		System.out.println(emp);
		System.out.println("Employee added successfuylly");
